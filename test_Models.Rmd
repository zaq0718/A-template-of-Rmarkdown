...
# Purpose
This document is to document a multilevel with a random intercept for a big-fish-pond effect **(BFLPE)**. [Mplus (**click me**)](https://www.statmodel.com/) was used to run the model.
...
The class level (Level 2): the average of individual reading performance for each class to predict individual self-concept.
...
**Note**. Mplus automatically calculated the average of reading performance for each class 
          because you did not make a claim in the USEVAR.


### Mplus output:
```{r fig_output, echo=FALSE,fig.cap="Model Results from Mplus", out.width='100%',fig.align='center'}
